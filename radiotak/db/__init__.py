...
class LocationObservation(Base):
    ...
    forwarding_reason: Mapped[str | None] = mapped_column(String(256), nullable=True)
    tak_server_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    cot_uid: Mapped[str | None] = mapped_column(String(128), nullable=True)
...
class RadioIdentity(Base):
    ...
    last_talkgroup_id: Mapped[str | None] = mapped_column(String(64), nullable=True)
    last_encrypted: Mapped[bool] = mapped_column(Boolean, default=False)
    last_encryption_algorithm: Mapped[str | None] = mapped_column(String(32), nullable=True)
    last_encryption_key_id: Mapped[str | None] = mapped_column(String(32), nullable=True)
...
class TakServer(Base):
    ...
    credential_secret_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ...
    client_key_password_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    pkcs12_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
    pkcs12_password_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    callsign: Mapped[str | None] = mapped_column(String(128), nullable=True)
    device_uid: Mapped[str | None] = mapped_column(String(128), nullable=True)
    # Marker / CoT appearance (per TAK server)
    default_callsign: Mapped[str | None] = mapped_column(
        String(128), nullable=True, default="Radio"
    )
    cot_type_default: Mapped[str] = mapped_column(String(64), default="a-n-G")
    iconset_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
    ...
    presence_lat: Mapped[float | None] = mapped_column(Float, nullable=True)
    presence_lon: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    active_groups: Mapped[list | None] = mapped_column(JSON, nullable=True)
...
class SdrDevice(Base):
    ...
    usb_path: Mapped[str | None] = mapped_column(String(128), nullable=True)
    sample_rate: Mapped[int | None] = mapped_column(Integer, nullable=True)
    center_frequency_hz: Mapped[int | None] = mapped_column(Integer, nullable=True)
...
class RadioSystem(Base):
    ...
    decoder: Mapped[str] = mapped_column(String(64), default="sdrtrunk")
    sdr_device_ids: Mapped[list | None] = mapped_column(JSON, nullable=True)
...
class ForwardingEvent(Base):
    ...
    tak_server_id: Mapped[str | None] = mapped_column(String(36), nullable=True, index=True)
